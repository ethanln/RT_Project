...
class ShapeUtil
{
	...
	//	/**
	//	* Private global checks to see if point is in triangle.
	//	*/
	//	static bool IS_POINT_IN_TRIANGLE(glm::vec3 point, Triangle triangle);

	//	/**
	//	* Private global checks to see if point is on the plane of the triangle.
	//	*/
	//	static bool IS_ON_PLANE(glm::vec3 point, Triangle triangle);

	//	/**
	//	* Private global checks to see if a line interesects a sphere.
	//	*/
	//	static bool DOES_INTERSET_SPHERE(glm::vec3 direction, glm::vec3 origin, Sphere sphere);
};
